...
public class OrcColumnarBatchJniReaderSparkORCNotPushDownTest extends TestCase {
    ...
    public void initReaderJava() {
        ...
        File directory = new File("src/test/java/com/huawei/boostkit/spark/jni/part-00000-2d6ca713-08b0-4b40-828c-f7ee0c81bb9a-c000.snappy.orc");
    ...
    public void testNext() {
        ...
        String tmp2 = new String(vec3.get(4096));
